...
Spaceship.prototype.move = function() {
  if (this.coord.getX !== this.enemy.coord.getX) {
    if (this.coord.getX < this.enemy.coord.getX) {
      this.coord.getX = (this.enemy.coord.getX - this.coord.getX) >= 10 ? 
          this.coord.getX + 10 : this.coord.getX + (this.enemy.coord.getX - this.coord.getX);
    } else {
      this.coord.getX = (this.enemy.coord.getX - this.coord.getX) >= 10 ? 
          this.coord.getX - 10 : this.coord.getX - this.enemy.coord.getX - this.coord.getX;
    }
    ...
    if (this.coord.getY !== this.enemy.coord.getY) {
       if (this.coord.getY < this.enemy.coord.getY) {
        this.coord.getY = (this.enemy.coord.getY - this.coord.getY) >= 10 ? 
          this.coord.getY + 10 : this.coord.getY + (this.enemy.coord.getY - this.coord.getY);
      } else {
        this.coord.getY = (this.enemy.coord.getY - this.coord.getY) >= 10 ? 
          this.coord.getY - 10 : this.coord.getY - (this.enemy.coord.getY - this.coord.getY);
      }
